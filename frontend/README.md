...
The current UI uses a small browser-only demo classifier so it can be previewed without the Python backend. These browser predictions are not the final trained ML model.
